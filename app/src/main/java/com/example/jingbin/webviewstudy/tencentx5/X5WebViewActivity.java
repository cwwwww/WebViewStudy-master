...
import com.example.jingbin.webviewstudy.MyWebView;
...
public class X5WebViewActivity extends AppCompatActivity implements IWebPageView {
    ...
    private void initSwipe() {
        swipe.setColorSchemeColors(getResources().getColor(android.R.color.holo_blue_bright), getResources().getColor(android.R.color.holo_green_light),
                getResources().getColor(android.R.color.holo_orange_light), getResources().getColor(android.R.color.holo_red_light));

        webView.setSwipeRefreshLayout(swipe);
